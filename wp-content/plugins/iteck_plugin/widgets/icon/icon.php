 ...
 * @since 1.0.0
 */
class Iteck_Icon extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Iteck Icon', 'iteck_plg' );
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Primary Background', 'elementor' ),
				'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ],
				'selectors' => [
					'{{WRAPPER}}.elementor-view-stacked .elementor-icon-wrapper .elementor-icon',
				],
				// 'fields_options' => [
				// 	'stacked_background' => [
				// 		'default' => 'classic',
