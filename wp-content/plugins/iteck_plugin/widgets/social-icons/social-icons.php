 ...
 * @since 1.0.0
 */
class Iteck_Social_Icons extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Iteck Social Icons', 'iteck_plg' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => esc_html__( 'Official Color', 'iteck_plg' ),
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}}.iteck-social-icon' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}}.iteck-social-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} {{CURRENT_ITEM}}.iteck-social-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'rounded',
				'options' => [
					'rounded' => esc_html__( 'Rounded', 'iteck_plg' ),
		...
		$this->add_responsive_control(
			'columns',
			[
				'label' => esc_html__( 'Columns', 'iteck_plg' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
				'options' => [
					'0' => esc_html__( 'Auto', 'iteck_plg' ),
					'1' => '1',
					'2' => '2',
					'3' => '3',
					'4' => '4',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .iteck-social-icon' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .iteck-social-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .iteck-social-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .iteck-social-icon' => 'padding: {{SIZE}}{{UNIT}}',
				],
				'default' => [
					'unit' => 'em',
				],
		...
		$this->add_responsive_control(
			'row_gap',
			[
				'label' => esc_html__( 'Rows Gap', 'iteck_plg' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .iteck-social-icon',
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon Hover', 'iteck_plg' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .iteck-social-icon:hover',
				'exclude' => ['image'],
				'condition' => [
					'icon_color' => 'custom',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .iteck-social-icon:hover i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .iteck-social-icon:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
