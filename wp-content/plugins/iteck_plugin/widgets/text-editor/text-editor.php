 ...
 * @since 1.0.0
 */
class Iteck_Text_Editor extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Iteck Text Editor', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'links_color',
			[
				'label' => esc_html__( 'Links Color', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'links_color_hover',
			[
				'label' => esc_html__( 'Links Color Hover', 'elementor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				'name' => 'typography',
				'selector' => '{{WRAPPER}}, {{WRAPPER}} p, {{WRAPPER}} h1, {{WRAPPER}} h2, {{WRAPPER}} h3, {{WRAPPER}} h4, {{WRAPPER}} h6, {{WRAPPER}} h5',
			]
		);
