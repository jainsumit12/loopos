(function($) {
    ...
    $("#elementor-preview-iframe").on("load", function() {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/iteck-mason-gallery.default', function($scope) {
			 $scope.find('.mason-gallery').imagesLoaded(function() { 
			 	$scope.find('.mason-gallery').isotope();
			 });
		});
		elementorFrontend.hooks.addAction('frontend/element_ready/iteck-post-four.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-testimonial.default', function($scope) {
        ...
        //for img-box slider
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-image-box-slider.default', function($scope) {
        ...
        //for img-box slider
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-work-process.default', function($scope) {
		...
		//for post slider
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-post-slider.default', function($scope) {
        ...
        //for menu
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-menu.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-portfolio-info.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-portfolio.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/iteck-portfolio-masonry.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/iteck-sidebar.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/iteck-texticon-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
		
		elementorFrontend.hooks.addAction('frontend/element_ready/iteck-team-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
