...
class pieCsutomCJ{
	...
	function __construct(){
		...
		if(!$this->wpccj_option){
			$options['pie_html_box_header'] = '';
			$options['pie_css_box_header'] = '';
			$options['pie_js_box_header'] = '';
			$options['pie_html_box_footer'] = '';
			$options['pie_css_box_footer'] = '';
			$options['pie_js_box_footer'] = '';
			$options['pie_wpccj_enable'] = 1;
			update_option("wpccj_option", $options);
		}
